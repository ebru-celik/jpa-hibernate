...
public class AppMain {
    public static void main(String[] args) {
        ...
        Order order1 = new Order ("Banana", "1000",1.90F,new Date());
        Order order2 = new Order ("Apple", "2000",4.12f,new Date());
        Order order3 = new Order ("Orange", "3000",5.88f,new Date());
